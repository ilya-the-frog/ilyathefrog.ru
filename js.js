...
const translations = {
  ru: {
    ...
    'publications.rbc.publisher': 'РБК',
    'publications.rbc': 'Вовлекай и властвуй: зачем компании играют в игры с сотрудниками',
  ...
  en: {
    ...
    'about.proof.experience.value': '7+',
    'about.proof.experience.label': 'years in Tech',
    ...
    'publications.innovazia': 'Strategies for the transition to domestic operating systems in the Tech infrastructure of banks',
    ...
    'publications.rbc.publisher': 'RBC',
    'publications.rbc': 'Engage and conquer: why companies play games with their employees',
